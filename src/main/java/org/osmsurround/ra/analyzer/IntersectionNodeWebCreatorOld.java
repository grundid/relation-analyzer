...
public class IntersectionNodeWebCreatorOld {
	...
	public IntersectionNodeWebCreatorOld(List<ISegment> segments) {
		this.segments = segments;
	}

	public void createWeb() {
		Node node = determineFirstIntersectionNode(segments);
		createWebStartingWithNode(node);
	}

	public void createWebStartingWithNode(Node node) {
